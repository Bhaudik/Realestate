...
<div class="page-content">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <!-- Export Button -->
            &nbsp;
            <a href="{{ route('export.permissions') }}" class="btn btn-inverse-success" rel="noopener noreferrer">Export</a>
            <!-- Import Button -->
            &nbsp;
            <a href="{{ route('import.permissions.view') }}" class="btn btn-inverse-danger" rel="noopener noreferrer">Import</a>
        </ol>
    </nav>
